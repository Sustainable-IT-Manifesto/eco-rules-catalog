...
**Name:** Excessive hydration for mostly static pages
...
- **guidance:** Use islands/partial hydration, server components, static rendering, or progressive enhancement.
...
### Excessive hydration for mostly static pages
...
Use islands/partial hydration, server components, static rendering, or progressive enhancement.
