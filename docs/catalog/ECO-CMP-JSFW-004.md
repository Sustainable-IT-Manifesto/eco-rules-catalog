...
**Name:** Polling loop without visibility or lifecycle controls
...
- **guidance:** Use event-driven updates, backoff, visibility checks, caching, and stale-while-revalidate patterns.
...
### Polling loop without visibility or lifecycle controls
...
Use event-driven updates, backoff, visibility checks, caching, and stale-while-revalidate patterns.
