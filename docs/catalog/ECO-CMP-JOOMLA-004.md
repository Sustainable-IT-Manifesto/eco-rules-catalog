...
**Name:** Disabled or bypassed Joomla cache
...
- **guidance:** Use Joomla cache APIs and define invalidation behavior for modules, views, and computed fragments.
...
### Disabled or bypassed Joomla cache
...
Use Joomla cache APIs and define invalidation behavior for modules, views, and computed fragments.
