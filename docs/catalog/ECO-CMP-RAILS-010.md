...
**Name:** Asset pipeline ships unused JavaScript or CSS
...
- **guidance:** Split bundles by page need, remove unused dependencies, and use modern asset analysis.
...
### Asset pipeline ships unused JavaScript or CSS
...
Split bundles by page need, remove unused dependencies, and use modern asset analysis.
