...
**Name:** Unbounded module rendering on every page
...
- **guidance:** Constrain modules by menu/page context and cache expensive module output.
...
### Unbounded module rendering on every page
...
Constrain modules by menu/page context and cache expensive module output.
